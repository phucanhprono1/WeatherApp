...
interface ForecastRepository {
    ...
    suspend fun getFutureWeatherListByLocationKey(startDate: LocalDate, locationKey: String, metric: Boolean): LiveData<out List< UnitLocalizedFiveDaysForecastWeather>>
